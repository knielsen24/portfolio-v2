function ColorSplash1() {
  return (
    <div
      className="absolute bottom-0 left-0 right-0 -z-10 -ml-24 transform-gpu overflow-hidden blur-3xl lg:ml-24 xl:ml-48"
      aria-hidden="true"
    >
      <div
