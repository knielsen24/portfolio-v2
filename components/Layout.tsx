...
function SquareBlocks() {
  return (
    <svg
      className="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-slate-300/80 [mask-image:radial-gradient(28rem_28rem_at_center,white,transparent)] dark:stroke-slate-600/80 dark:[mask-image:radial-gradient(24rem_24rem_at_center,white,transparent)]"
      aria-hidden="true"
    >
      <defs>
        <pattern
...
const Layout: React.FC<Props> = ({ children }) => {
  return (
    <>
      <div className="absolute inset-0 overflow-hidden flex justify-center sm:px-8">
